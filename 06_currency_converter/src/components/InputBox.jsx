...
function InputBox({
  ...
  return (
    <div className={`bg-white/70 p-3 rounded-lg text-sm flex ${className}`}>
        ...
        <div className='w-1/2'>
            <label htmlFor={id} className='text-black/70 mb-2 inline-block'>{label}</label>
            <input
            id={id}
            type="number"
        ...
        <div className='w-1/2 flex flex-wrap justify-end text-right'>
            ...
            <select
            className='rounded-lg px-1 py-1 bg-customGray cursor-pointer outline-none text-white'
